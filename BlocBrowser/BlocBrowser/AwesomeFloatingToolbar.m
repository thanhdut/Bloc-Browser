...
- (UIColor *) backgroundColorAtIndex:(NSInteger)index {
    return ((UILabel *)self.buttons[index]).backgroundColor;
}

- (void) longPressFired:(UILongPressGestureRecognizer *) recognizer {
    UIColor *newColor = [self backgroundColorAtIndex:2];
    UIColor *placeholder = [self backgroundColorAtIndex:0];
    ((UILabel *)self.buttons[0]).backgroundColor = newColor;
    newColor = placeholder;
    placeholder = [self backgroundColorAtIndex:1];
    ((UILabel *)self.buttons[1]).backgroundColor = newColor;
    newColor = placeholder;
    placeholder = [self backgroundColorAtIndex:3];
    ((UILabel *)self.buttons[3]).backgroundColor = newColor;
    newColor = placeholder;
    ((UILabel *)self.buttons[2]).backgroundColor = newColor;
}
